...
public class CustomDateTimePickerDialog extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.customer_dialog_datetime_picker, container, false);
    ...
    private void initViews(View view) {
        ...
        // Ensure 7-day columns to avoid compression
        glCalendar.setColumnCount(7);
    }
